...
After we learned about advanced locks and read-write locks, we told our friend Bob that
we now know how to protect.
shared resources with special locks that keep our application thread-safe and efficient.
Bob just completed a mission-critical class for his online store that maintains the store
products' reviews, and he asked us for help.
